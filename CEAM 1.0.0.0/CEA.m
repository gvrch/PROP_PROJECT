...
% x=CEA('problem','tp','equilibrium','o/f',6.0:.2:7.0,'case','CEAM-TP1','p,psi',1000.,2000,'t,R',5500:500:6500,'outp', ...
%     'transport','reactants','fuel','H2','wt%',100.,'t(k)',298.15,'oxid','O2','wt%',100,'t(k)',298.15,'end','screen');
